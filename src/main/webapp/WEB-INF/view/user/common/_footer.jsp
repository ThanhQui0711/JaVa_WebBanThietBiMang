      ...
      <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
        <div class="box-footer info-contact">
          ...
          <div class="content-contact">
            ...
            <p>
              <strong>Địa chỉ:</strong> Thu Duc Cuty
            </p>
            <p>
              <strong>Email: </strong> truogqui0711@gmail.com
            </p>
            <p>
              <strong>Điện thoại: </strong> 0354094325
            </p>
          </div>
        </div>
      </div>
            ...
            <form action="/" method="GET" role="form">
              <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                  <input type="email" name="" class="form-control" placeholder="Địa chỉ mail">
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
